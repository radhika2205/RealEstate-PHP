...
if(isset($_POST['add']))
{
	...
	size='{$asize}', price='{$price}', location='{$loc}', city='{$city}', state='{$state}',
	 pimage1='{$aimage1}', pimage2='{$aimage2}', pimage3='{$aimage3}', pimage4='{$aimage4}',
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="price" required value="<?php echo $row['7']; ?>">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">City</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="city" required value="<?php echo $row['9']; ?>">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">State</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="state" required value="<?php echo $row['10']; ?>">
													</div>
												</div>
											</div>
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="asize" required value="<?php echo $row['6']; ?>">
													</div>
												</div>
												<div class="form-group row">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img src="admin/property/<?php echo $row['11'];?>" alt="pimage1" height="150" width="180">
													</div>
												</div>
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img src="admin/property/<?php echo $row['12'];?>" alt="pimage2" height="150" width="180">
													</div>
												</div>
												<div class="form-group row">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img src="admin/property/<?php echo $row['13'];?>" alt="pimage3" height="150" width="180">
													</div>
												</div>
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img src="admin/property/<?php echo $row['14'];?>" alt="pimage4" height="150" width="180">
													</div>
												</div>
