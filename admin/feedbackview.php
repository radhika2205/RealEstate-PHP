                            ...
                            <table id="basic-datatable" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="feedbackedit.php?id=<?php echo $row['fid']; ?>"><button class="btn btn-info">Edit</button></a>
                                            <a href="feedbackdelete.php?id=<?php echo $row['fid']; ?>"><button class="btn btn-danger">Delete</button></a>
                                        </td>
                                    </tr>
                                    <?php
                                    $cnt++;
