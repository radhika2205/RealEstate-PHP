...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $ptype = mysqli_real_escape_string($conn, trim($_POST['ptype']));
    $bhk = mysqli_real_escape_string($conn, trim($_POST['bhk']));
    $stype = mysqli_real_escape_string($conn, trim($_POST['stype']));
    $price = mysqli_real_escape_string($conn, trim($_POST['price']));
    $city = mysqli_real_escape_string($conn, trim($_POST['city']));
    $asize = mysqli_real_escape_string($conn, trim($_POST['asize']));
    ...
    $sql = "INSERT INTO property (title, pcontent, type, bhk, stype, size, price, location, city, state, status, uid, pimage1, pimage2, pimage3, pimage4) 
        VALUES ('$title', '$content', '$ptype', '$bhk', '$stype', '$asize', '$price', '$loc', '$city', '$state', '$status', '$uid','$aimage1','$aimage2','$aimage3','$aimage4')";


if (mysqli_query($conn, $sql)) {
    echo "<script>alert('Property submitted successfully! Waiting for admin approval.'); window.location.href='submitproperty.php';</script>";
    exit();
}
