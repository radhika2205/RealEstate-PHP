<header id="header" class="transparent-header-modern fixed-header-bg-white w-100">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <nav class="navbar navbar-expand-lg navbar-light p-0"> <a class="navbar-brand position-relative" href="index.php"><img class="nav-logo" src="images/logo/logo_small_hd.png" alt=""></a>
        ...
        <!-- 1087 thi top header ni css thy che chalu -->
         <!-- 1170 sudhi css chale che -->
