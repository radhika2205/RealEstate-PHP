            ...
            <div class="container">
					...
					<table class="items-list col-lg-12 table-hover" style="border-collapse:inherit;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
									<img src="admin/property/<?php echo $row['11'];?>" alt="aimage1">
                                    <div class="property-info d-table">
                                        <h5 class="text-secondary text-capitalize"><a href="propertydetail.php?pid=<?php echo $row['0'];?>"><?php echo $row['1'];?></a></h5>
                                        <span class="font-14 text-capitalize"><i class="fas fa-map-marker-alt text-success font-13"></i>&nbsp; <?php echo $row['8'];?></span>
                                        <div class="price mt-3">
											<span class="text-success">Rs.&nbsp;<?php echo $row['7'];?></span>
										</div>
                                    </div>
								</td>
