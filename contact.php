...
session_start();
include("config.php"); // Ensure this file exists and has correct database connection
...
if (isset($_POST['send'])) {
    ...
    if (!empty($name) && !empty($email) && !empty($phone) && !empty($subject) && !empty($message)) {
        ...
        // Ensure you are using correct variable name from config.php
                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white">nani kadi</span>
